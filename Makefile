...
# snappcloud.io/mongodb-data-operator-bundle:$VERSION and snappcloud.io/mongodb-data-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= snappcloud.io/mongodb-data-operator
...
IMG ?= 127.0.0.1:5001/mongodb-data-operator
